                            ...
                            <div class="tab-content">
                                ...
                                <div id="step-{{$key+1}}" class="tab-pane" role="tabpanel" aria-labelledby="step-{{$key+1}}">
                                    ...
                                    <div class="input-group input-group-lg">
                                        ...
                                        <textarea @if($value->req=="yes") required @endif name="{{$value->name}}" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg"></textarea>
                                        @else
                                        <input @if($value->req=="yes") required @endif type="{{$value->type}}" name="{{$value->name}}" class=" form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg">
                                        @endif
                                    </div>
                                </div>
                                @endforeach
