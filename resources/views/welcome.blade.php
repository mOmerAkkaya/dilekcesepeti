@extends('layouts.app')
@section('home','active')
@section("title","Dilekçe Sepeti, Dilekçe Yazmanın Yeni Yolu, Hızlıca Dilekçe Yazın")
@section("description","Dilekçe Sepeti, Türkiye'nin lider dilekçe ve evrak çözümleri sağlayıcısıdır. Dilekçe örneklerini indirebilir, dilerseniz dilekçe örneklerine ulaşabileceğiniz bir web sitesidir. Tüm dilekçe ve evrak işlemleriniz için doğru adres")
@section('content')
<!-- ======= Hero Section ======= -->
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="card">
                        ...
                        <h3><a href="{{route('icerik.show',['hukuki-danismanlik'])}}" class="stretched-link">{{ __('pages/index.services.third') }}</a></h3>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="card">
                        ...
                        <h3><a href="{{route('icerik.show',['dava-dilekcesi'])}}" class="stretched-link">{{ __('pages/index.services.fourth') }}</a></h3>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="500">
                    <div class="card">
                        ...
                        <h3><a href="{{route('icerik.show',['suc-duyurusu-dilekcesi'])}}" class="stretched-link">{{ __('pages/index.services.fifth') }}</a></h3>
                ...
                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="600">
                    <div class="card">
                        ...
                        <h3><a href="{{route('icerik.show',['idari-dilekceler'])}}" class="stretched-link">{{ __('pages/index.services.sixth') }}</a></h3>
